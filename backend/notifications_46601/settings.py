"""
Django settings for notifications_46601 project.
...
ROOT_URLCONF = 'notifications_46601.urls'
...
WSGI_APPLICATION = 'notifications_46601.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "notifications_46601 API",
    "DESCRIPTION": "API documentation for notifications_46601 App",
    "VERSION": "v1",
}
